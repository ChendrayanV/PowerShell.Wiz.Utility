...
```
Add-PSWizServiceAccount [-Name] <Object> [-Scopes] <Object> [-AssignedProjectId] <Object> [-Type] <Object>
 [-ExpiresAt] <DateTime> [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
...
### -AssignedProjectId
{{ Fill AssignedProjectId Description }}
